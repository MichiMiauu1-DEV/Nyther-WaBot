...
export const defSets = {
  ...
  nameid: 'Nombre del canal',
  type: 'Owner',
  link: 'https://free.xubi.org/',
...
export function initDB() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS settings (
      ...
      newsletter_id TEXT DEFAULT '120363427108760056@newsletter',
      nameid TEXT DEFAULT 'Nombre del canal',
      type TEXT DEFAULT 'Owner',
      link TEXT DEFAULT 'https://free.xubi.org/',
