...
export default {
  ...
  run: async ({ msg, sock, usedPrefix }) => {
    ...
    if (now < user.lastcoffer) {
      ...
      return msg.reply(`《✧》 ¡ALTO AHÍ, SQUELETO AMBICIOSO! Tus manos virtuales ya saquearon un cofre hoy. El dispensador cuántico necesita enfriarse. Regresa en: *${msToTime(restante)}*.`);
    }
