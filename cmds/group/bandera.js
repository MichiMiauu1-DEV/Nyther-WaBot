...
const cleanGame = (g) => {
  ...
  if (g.flagInterval) clearInterval(g.flagInterval); // FIX COOLDOWN BUG
  g.flagTimer = null;
  g.flagInterval = null;
  g.flagActive = null;
};
...
╰━━━━━━━━━━━━━━━`
      ...
      if (isCorrect) {
        ...
        // ✅ FIX LOGRO NO APARECE
        const newWin = u.flagWins;
...
╰━━━━━━━━━━━━━━━`;
        ...
        // 🔥 LOGRO FIX REAL
        if (newWin === 1 && !u.achievements.find(a => a.id === "flag_starter")) {
          u.achievements.push({
            id: "flag_starter",
